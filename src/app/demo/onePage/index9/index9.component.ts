...
@Component({
  selector: 'app-index9',
  imports: [Index9NavbarComponent, RouterLink,Index9HeroComponent, Index9AboutComponent, Index9ChooseComponent, Index9WorkComponent, Index9ShopComponent, Index9TestiComponent, Index9InstaComponent],
